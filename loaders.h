...
namespace pyrodactyl
{
	...
	struct TextAlign
	{
		...
		TextAlign() { x = ALIGN_LEFT; y = ALIGN_LEFT; }
	};
	...
	bool LoadNum(float &val, const std::string &name, rapidxml::xml_node<char> *node, const bool &echo = true);
#endif
	...
	//Load Color
	bool LoadColor(GLrgba &col, rapidxml::xml_node<char> *node, const bool &echo = true,
		const std::string &r_name = "r", const std::string &g_name = "g", const std::string &b_name = "b", const std::string &a_name = "a");

/*-----------------------------------------------------------------------------
  ...
  The Mersenne Twister by Matsumoto and Nishimura. It sets new standards for
  the period, quality and speed of random number generators. The incredible
  period is 2^19937 - 1, a number with about 6000 digits; the 32-bit random
  numbers exhibit best possible equidistribution properties in dimensions
  up to 623; and it's fast, very fast.
...
{
	return GLvector2(RandomFloat() * 2, RandomFloat() * 2) - GLvector2(1, 1);
}
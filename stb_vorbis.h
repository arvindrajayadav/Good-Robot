...
#endif
	//extern int xstb_vorbis_decode_memory(unsigned char *mem, int len, int *channels, short **output);
	int stb_vorbis_decode_memory(unsigned char *mem, int len, int *channels, int* rate, short **output);
